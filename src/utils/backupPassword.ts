...
// password first, then one email link click (not a full "forgot PIN"
// reset), unlike the per-device secret the PIN normally unlocks. See
...
// itself: the caller follows up with the existing "Verify This Device"
// email link as a second factor, since this is reachable with no session
// at all.
