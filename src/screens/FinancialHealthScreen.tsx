...
// FinancialAssessmentScreen and SolveScreen). This one calls an external
// third party (Pngme) that estimates income from mobile money/bank SMS
// text — a different data source for a different purpose (income
