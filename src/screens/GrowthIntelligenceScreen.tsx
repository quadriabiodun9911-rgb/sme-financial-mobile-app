...
const gs = StyleSheet.create({
    ...
    highlightBox: { flex: 1, backgroundColor: Colors.surface, borderRadius: Radius.md, padding: 14, alignItems: 'center', borderWidth: 1, ...Shadow.sm },
    ...
    // Performers tab
    focusCard:   { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: Colors.surface, borderRadius: Radius.md, padding: 14, marginBottom: Spacing.md, borderWidth: 1, borderColor: Colors.primary + '44', ...Shadow.sm },
    focusText:   { flex: 1, fontSize: 13, color: Colors.textPrimary, lineHeight: 20 },
    riskBanner:  { borderWidth: 1, borderRadius: 10, padding: Spacing.md, marginBottom: Spacing.md, backgroundColor: Colors.expense + '11', ...Shadow.sm },
