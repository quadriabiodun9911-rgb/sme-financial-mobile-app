...
const s = StyleSheet.create({
    ...
    fiveCsCard: { backgroundColor: Colors.surface, borderRadius: 12, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: Colors.border, ...Shadow.sm },
    ...
    visibilityCard: { backgroundColor: Colors.surface, borderRadius: 12, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: Colors.border, ...Shadow.sm },
    ...
    capacityCard: { backgroundColor: Colors.surface, borderRadius: 12, padding: 16, marginBottom: 20, borderLeftWidth: 4, borderLeftColor: Colors.income, ...Shadow.sm },
    ...
    tipsBox: { backgroundColor: Colors.primary + '15', borderRadius: 12, padding: 16, borderLeftWidth: 4, borderLeftColor: Colors.primary, ...Shadow.sm },
...
const fp = StyleSheet.create({
    ...
    card: { backgroundColor: Colors.card, borderRadius: 14, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: Colors.border, ...Shadow.sm },
    ...
    scoreCard: { backgroundColor: Colors.card, borderRadius: 14, borderTopWidth: 4, padding: 16, marginBottom: 16, alignItems: 'center', ...Shadow.sm },
