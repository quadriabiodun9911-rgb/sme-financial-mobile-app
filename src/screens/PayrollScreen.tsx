                        ...
                        {[...payrollRuns].sort((a, b) => b.period.localeCompare(a.period)).map(run => (
                            <View key={run.id} style={styles.runCard}>
                                <View style={styles.runCardHeader}>
                                    <View>
                                        <View style={styles.runPeriodRow}>
...
const styles = StyleSheet.create({
    ...
    runPeriodRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    runPeriod: { fontSize: 16, fontWeight: '800', color: Colors.textPrimary },
    autoBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: Colors.primary + '15', borderRadius: Radius.pill, paddingHorizontal: 6, paddingVertical: 2 },
