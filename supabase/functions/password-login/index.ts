...
//                    follows up with a typed 6-digit email code
//                    (signInWithOtp + verifyOtp, entered in the same tab)
//                    as a second factor, since this is the one login path
//                    reachable with no session and no device of its own to
//                    vouch for it. Verifying that code is what actually
//                    produces the session, which the client then feeds into
//                    the existing device-verify flow (set a PIN for this
